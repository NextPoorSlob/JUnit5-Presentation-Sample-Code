...
/**
 * Catching errors in JUnit5. The @Test annotation no longer has an expected
 * clause.
 * 
...
class IntegerCalculatorTest {
	...
	/**
	 * What about when you want the assertThrows to fail? Catch the
	 * AssertionFailedError! Or, better yet, don't be a nimrod and write an
	 * assertThrows statement in the first place.
	 */
	@Test
	void divide_When15DividedBy3_ThenNoException() {

		assertThrows(AssertionFailedError.class, () -> {
			// ArithmeticException not thrown, so assertThrows threw an
